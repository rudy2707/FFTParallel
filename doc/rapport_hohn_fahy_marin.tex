...
\begin{figure}[!ht]
    \center
    \includegraphics[width=5cm]{../images/evert_filtre_01.eps}
    \caption{Image filtrée à 1\%}
\end{figure}

\begin{figure}[!ht]
    \center
    \includegraphics[width=5cm]{../images/evert_filtre_02.eps}
    \caption{Image filtrée à 2\%}
\end{figure}

\begin{figure}[!ht]
    \center
    \includegraphics[width=5cm]{../images/evert_filtre_05.eps}
    \caption{Image filtrée à 5\%}
\end{figure}

\begin{figure}[!ht]
    \center
    \includegraphics[width=5cm]{../images/evert_filtre_10.eps}
    \caption{Image filtrée à 10\%}
\end{figure}

\begin{figure}[!ht]
    \center
    \includegraphics[width=5cm]{../images/evert_filtre_15.eps}
